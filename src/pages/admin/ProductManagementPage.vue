      ...
      <q-card style="width: 500px">
        ...
        <q-card-section>
          <q-form @submit="onSubmit" class="q-gutter-md">
            ...
            <q-input v-model="form.category" label="카테고리" filled />
...
const form = ref({ id: null, name: '', price: 0, stockQuantity: 0, category: 'FLOWER', thumbnailUrl: '', description: '' })
...
const openDialog = (product = null) => {
  if (product) {
    ...
    form.value = { id: null, name: '', price: 0, stockQuantity: 0, category: 'FLOWER', thumbnailUrl: '', description: '' }
  }
